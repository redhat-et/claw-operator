---
name: "source-command-commit-with-message"
description: "Create a commit with a message based on the staged changes"
---

# source-command-commit-with-message

Use this skill when the user asks to run the migrated source command `commit-with-message`.
